...
public interface ApiModule {
    ...
    @Singleton
    @Provides
    static PlashikiVideoApi bindPlashikiVideoApi(@com.gnoemes.shikimori.di.app.annotations.PlashikiVideoApi Retrofit retrofit) {
        return retrofit.create(PlashikiVideoApi.class);
    }
