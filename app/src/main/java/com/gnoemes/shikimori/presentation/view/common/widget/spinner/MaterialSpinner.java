...
package com.gnoemes.shikimori.presentation.view.common.widget.spinner;
...
public class MaterialSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            adapterTextColor = ta.getColor(R.styleable.MaterialSpinner_ms_text_color, textColor);
            adapterTextSize = 12f;
        } finally {
            ta.recycle();
        }
...
//    popupWindow.setWidth(MeasureSpec.getSize(widthMeasureSpec));
    ...
    public void setTextColor(int color) {
        textColor = color;
        if (adapter != null) {
            adapter.setTextColor(adapterTextColor);
    ...
    public <T> void setItems(@NonNull List<T> items) {
        adapter = new MaterialSpinnerAdapter<>(getContext(), items)
                ...
                .setTextSize(adapterTextSize)
                .setTextColor(adapterTextColor);
    ...
    public <T> void setAdapter(MaterialSpinnerAdapter<T> adapter) {
        ...
        this.adapter.setTextColor(adapterTextColor);
        this.adapter.setTextSize(adapterTextSize);
    ...
    public int getAdapterTextColor() {
        return adapterTextColor;
    }

    public void setAdapterTextColor(@ColorInt  int adapterTextColor) {
        this.adapterTextColor = adapterTextColor;
    }

    public float getAdapterTextSize() {
        return adapterTextSize;
    }

    public void setAdapterTextSize(float adapterTextSize) {
        this.adapterTextSize = adapterTextSize;
    }
