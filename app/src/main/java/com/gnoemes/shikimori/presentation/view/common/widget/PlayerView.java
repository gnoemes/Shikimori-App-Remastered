 ...
 * a layout file. This is achieved by setting the {@code player_layout_id} attribute on aF
...
public class PlayerView extends FrameLayout {
    ...
    private boolean controllerShowOnTouch;
    ...
    public PlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean controllerShowOnTouch = true;
    ...
    private boolean toggleControllerVisibility() {
        ...
        if (controllerShowOnTouch && !controller.isVisible()) {
            maybeShowController(true);
