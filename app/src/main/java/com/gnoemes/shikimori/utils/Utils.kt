...
object Utils {
    ...
    fun isHostingSupports(hosting: VideoHosting): Boolean {
        return when (hosting) {
            is VideoHosting.SIBNET, is VideoHosting.VK, is VideoHosting.SMOTRET_ANIME, is VideoHosting.SOVET_ROMANTICA, is VideoHosting.KODIK, is VideoHosting.OK, is VideoHosting.MYVI, is VideoHosting.ALLVIDEO, is VideoHosting.ANIMEJOY, is VideoHosting.DZEN -> true
            else -> false
        }
    }
