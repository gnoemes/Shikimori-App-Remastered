...
//                .asRxCompletable()
    ...
    override fun episodeWatched(animeId: Long, episodeId: Int): Completable = Completable.complete()
//            storIOSQLite
//                    .put()
...
//                    .asRxCompletable()
    ...
    override fun isEpisodeWatched(animeId: Long, episodeId: Int): Single<Boolean> = Single.just(false)
//            storIOSQLite
//                    .get()
...
//                    .onErrorReturnItem(false)
    ...
    override fun getWatchedAnimeIds(): Single<List<Long>> = Single.just(listOf(1L))
//            storIOSQLite
//                    .get()
