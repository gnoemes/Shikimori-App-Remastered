...
class ChapterDbSourceImpl @Inject constructor(
    ...
    override fun chapterReaded(mangaId: Long, chapterId: Int): Completable = Completable.complete()
//            storIOSQLite
//                    .put()
...
//                    .asRxCompletable()
    ...
    override fun isChapterReaded(mangaId: Long, chapterId: Long): Single<Boolean> = Single.just(true)
//            storIOSQLite
//                    .get()
...
//                    .onErrorReturnItem(false)
    ...
    override fun getReadedMangaIds(): Single<List<Long>> = Single.just(listOf(1L))
//            storIOSQLite
//                    .get()
